                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h3 class="card-title">Pending payment Order</h3>
...
export default {
    ...
    methods: {
        ...
        getWebOrders(){
            ...
            diniApi.get("orders?status=pending")
                .then((response) => {
        ...
        callback: function(page) {
            ...
            diniApi.get("orders?status=pending&page="+page+"&per_page="+this.per_page)
                .then((response) => {
// console.log(response);
        ...
        dateWiseOrderLoop(){
            ...
            diniApi.get("orders?after="+start+"T00:00:00&before="+end+"T00:00:00&page="+this.dateWisePage+"&per_page=100&status=pending")
                .then((response) => {
        ...
        orderSearch(event){
            ...
            diniApi.get("orders?search="+event.target.value+"&status=pending")
                .then((response) => {
                    this.orders = response.data;
                })
                .catch((error) => {
