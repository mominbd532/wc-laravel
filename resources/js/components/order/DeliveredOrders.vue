...
export default {
    ...
    methods: {
        ...
        getWebOrders(){
            ...
            diniApi.get("orders?status=delivered")
                .then((response) => {
        ...
        callback: function(page) {
            ...
            diniApi.get("orders?status=delivered&page="+page+"&per_page="+this.per_page)
                .then((response) => {
// console.log(response);
        ...
        dateWiseOrderLoop(){
            ...
            diniApi.get("orders?after="+start+"T00:00:00&before="+end+"T00:00:00&page="+this.dateWisePage+"&per_page=100&status=delivered")
                .then((response) => {
        ...
        orderSearch(event){
            ...
            diniApi.get("orders?search="+event.target.value+"&status=delivered")
                .then((response) => {
                    this.orders = response.data;
                })
                .catch((error) => {
